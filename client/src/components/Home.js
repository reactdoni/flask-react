            ...
            >
                ...
                <Modal.Body>
                    <form>
                        ...
                        {errors.title?.type === 'maxLength' && <p style={{color:'red'}}><small>Title should be 25 characters max</small></p>}
                        ...
                        {errors.description?.type === 'maxLength' && <p style={{color:'red'}}><small>Description should be 255 characters max</small></p>}
                        <br></br>
                        <Form.Group>
